...
class QRScannerApp:
    def __init__(self):
        ...
        self.title = '<span>ASAP<br>Amikom Safe Park</span>'
    ...
    def scan_qr_page(self):
        with st.container():
            st.write("<h2 style='text-align: center;'>Scan QR KTM</h2>", unsafe_allow_html=True)
            
            run_checkbox = st.checkbox('Jalankan QR Scan', value=st.session_state.run, key="run_checkbox")
    ...
    def run(self):
        st.markdown("""
            ...
            .title {
                ...
                font-weight: bold;
                color: #ffffff;
                background: -webkit-linear-gradient(left, #8e44ad, #8e44ad);
